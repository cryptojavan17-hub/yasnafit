...
> آخرین به‌روزرسانی: **2026-09-20** (توسط Agent جلسهٔ `arena/01a0b993-yasnafit` — **Task 25 (شماره‌گذاری docs/project-tracking): بازسازی لندینگ — مرحلهٔ ۱ از ۴: هیرو بر اساس Hero.png + اصلاح سایز/تعادل طبق گزارش مالک (عکس قاب‌بندی‌شده بدون زوم، متن متعادل، فضا برای دکمه‌های آینده) — مرحله‌های ۲–۴ منتظر تصویرهای دیگر مالک**. قبل‌تر: Task 17–24 (همه committed + push شده). جلسهٔ قبل: `arena/01a0817f-yasnafit` — Task 25/26).
...
* **Task 25 (2026-09-20، درخواست مالک — بازسازی لندینگ، مرحلهٔ ۱ از ۴: هیرو + اصلاح سایز/تعادل):** Hero.png ⇒ هیرو دو ستون متعادل (عکس چپ ~۴۸٪ قاب‌بندی‌شده با سقف سایز، بدون زوم/برش — هویت چهره دست‌نخورده + لوگو «yasnafit.ir» + تیتر + لید راست) + فضای رزرو زیر پاراگراف برای دکمه‌های آینده + responsive. ✅ ۵۸ گروه + ۱۹/۱۹ + smoke سبز؛ committed + push شده. **مرحله‌های ۲–۴: منتظر تصویرهای دیگر مالک.**
