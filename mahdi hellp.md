...
| PR | **#6 باز** (Task 25 → main، فقط مستندات — merge فقط با تأیید مالک) • **#5 MERGED** (Task 24 → main، 2026-09-03 18:41:45Z با تأیید صریح مالک — merge commit `607587f`) • #4 MERGED (Task 23) • #3 MERGED • #2 MERGED • #1 CLOSED |
...
### What remains
1. **مالک:** merge **PR #6** (Task 25 — فقط مستندات)؛ چون فقط `.md` تغییر کرده، رفتار برنامه/production عوض نمی‌شود و ریست uptime ملاک نیست.
