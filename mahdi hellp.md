...
> آخرین به‌روزرسانی: **2026-09-20** (توسط Agent جلسهٔ `arena/01a0b993-yasnafit` — **Task 25 (شماره‌گذاری docs/project-tracking): بازسازی لندینگ — مرحلهٔ ۱ از ۴: بخش هیرو بر اساس Hero.png مالک (عکس دقیق مرجع + متن در HTML؛ بدون دکمه؛ responsive) — مرحله‌های ۲–۴ منتظر تصویرهای دیگر مالک**. قبل‌تر: Task 17–24 (همه committed + push شده). جلسهٔ قبل: `arena/01a0817f-yasnafit` — Task 25/26).
...
* **Task 25 (2026-09-20، درخواست مالک — بازسازی لندینگ، مرحلهٔ ۱ از ۴: هیرو):** «Hero.png» بارگذاری شد ⇒ هیرو = عکس دقیق مرجع (چپ، ~۴۴٪) + لوگو «yasnafit.ir» + تیتر «بدنی قوی‌تر، زندگی بهتر» + لید (راست، HTML واقعی) + بدون دکمه + responsive؛ هدر/فوتر دست‌نخورده؛ بقیهٔ بخش‌ها هنوز placeholder نیستند — فقط هیرو جایگزین placeholder شد. ✅ ۵۸ گروه + ۱۹/۱۹ + smoke سبز؛ committed + push شده. **مرحله‌های ۲–۴: منتظر تصویرهای دیگر مالک.**
