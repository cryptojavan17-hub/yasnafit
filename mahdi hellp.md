...
* **Task 26 (2026-09-20، درخواست مالک — دکمهٔ ربات تلگرام):** هدر عمومی: دکمهٔ «ربات تلگرام» با آیکون تلگرام (کنار ثبت نام/ورود؛ دسکتاپ + موبایل) → پروفایل شاگرد = بخش ربات تلگرام (ورود @username + دکمهٔ اتصال؛ ذخیره از طریق همان API موجود telegram_id). ✅ ۶۱ گروه + e2e سبز + smoke؛ committed + push شده.
