...
> آخرین به‌روزرسانی: **2026-09-20** (توسط Agent جلسهٔ `arena/01a0b993-yasnafit` — **Task 25 (شماره‌گذاری docs/project-tracking): بازسازی لندینگ — مرحلهٔ ۱ از ۴: هیرو = کل Hero.png بدون برش + سقف عرض 941px وسط‌چین (موبایل تمام‌عرض) — مرحله‌های ۲–۴ منتظر تصویرهای دیگر مالک**. قبل‌تر: Task 17–24 (همه committed + push شده). جلسهٔ قبل: `arena/01a0817f-yasnafit` — Task 25/26).
...
* **Task 25 (2026-09-20، درخواست مالک — بازسازی لندینگ، مرحلهٔ ۱ از ۴: هیرو):** پس از ردِّ برش/چیدمان‌ها ⇒ هیرو = **دقیقاً کل Hero.png** (byte-identical با main) + سقف عرض 941px وسط‌چین (موبایل: تمام‌عرض) + بدون متن HTML تکراری + هدر/فوتر دست‌نخورده. ✅ ۵۸ گروه + ۱۹/۱۹ + smoke سبز؛ committed + push شده. **مرحله‌های ۲–۴: منتظر تصویرهای دیگر مالک.**
