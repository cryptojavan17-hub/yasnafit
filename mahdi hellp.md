...
> آخرین به‌روزرسانی: **2026-09-20** (توسط Agent جلسهٔ `arena/01a0b993-yasnafit` — **Task 25 (شماره‌گذاری docs/project-tracking): بازسازی لندینگ — مرحلهٔ ۱ از ۴: هیرو + اصلاح ۲ ریشه‌ای لایه‌بندی (کانتینر سقف 1160px، ستون‌های متعادل با gap 40px، عکس contain بدون کشیدگی/برش، PNG lossless) — مرحله‌های ۲–۴ منتظر تصویرهای دیگر مالک**. قبل‌تر: Task 17–24 (همه committed + push شده). جلسهٔ قبل: `arena/01a0817f-yasnafit` — Task 25/26).
...
* **Task 25 (2026-09-20، درخواست مالک — بازسازی لندینگ، مرحلهٔ ۱ از ۴: هیرو + اصلاحات ۱ و ۲):** Hero.png ⇒ هیرو دو ستونهٔ متعادل: کانتینر سقف 1160px + ستون عکس 46٪ (contain — بدون کشیدگی/برش/زوم؛ PNG lossless دقیق مرجع) + ستون متن 54٪ (لوگو «yasnafit.ir» + تیتر + لید) با gap کنترل‌شده 40px + فضای رزرو زیر پاراگراف برای دکمه‌های آینده + responsive (موبایل: عکس قاب بالا + متن زیر). ✅ ۵۸ گروه + ۱۹/۱۹ + smoke سبز؛ committed + push شده. **مرحله‌های ۲–۴: منتظر تصویرهای دیگر مالک.**
