...
> آخرین به‌روزرسانی: **2026-09-20** (توسط Agent جلسهٔ `arena/01a0b993-yasnafit` — **Task 25 (شماره‌گذاری docs/project-tracking): بازسازی لندینگ — مرحلهٔ ۱ از ۴: هیرو = کل Hero.png بدون هیچ برش/فاصله/حذفی (دستور نهایی مالک؛ برش ۷۳۱px و نسخه‌های چیدمانی رد شد) — مرحله‌های ۲–۴ منتظر تصویرهای دیگر مالک**. قبل‌تر: Task 17–24 (همه committed + push شده). جلسهٔ قبل: `arena/01a0817f-yasnafit` — Task 25/26).
...
* **Task 25 (2026-09-20، درخواست مالک — بازسازی لندینگ، مرحلهٔ ۱ از ۴: هیرو = کل تصویر مرجع):** پس از ردِّ برش/چیدمان‌های HTML (اعتراض: «عکس نابود شده/وسطش دستکاری شده») ⇒ هیرو = **دقیقاً کل Hero.png** (byte-identical با main) تمام‌عرض + بدون متن HTML تکراری + هدر/فوتر دست‌نخورده + responsive. ✅ ۵۸ گروه + ۱۹/۱۹ + smoke سبز؛ committed + push شده. **مرحله‌های ۲–۴: منتظر تصویرهای دیگر مالک.**
