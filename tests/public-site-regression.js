...
(async () => {
  ...
  console.log('· public SSR pages');
  {
    ...
    assert.match(home, /تمامی حقوق محفوظ است/, 'footer: copyright line');
    assert.doesNotMatch(home, /site-footer__social/, 'footer: no social icons until real URLs are configured');
    assert.match(home, /site-footer__coach/, 'footer: coach login link kept');
