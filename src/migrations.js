...
const migrations = [
  ...
  {
    id: '041_remove_magazine_coach_notifications',
    description: 'Owner request (2026-09-23): the magazine section must not notify the coach panel — sending is removed from the discovery service and existing «magazine_review_ready» coach notifications are soft-deleted. Renumbered from 040 (that id now belongs to analytics_privacy); the statement is an idempotent soft-delete and safe to re-run.',
    up(db) {
