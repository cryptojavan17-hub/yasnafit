(() => {
  ...
  const labels={
    ...
    exercise:'تمرینی',diet:'غذایی',supplement:'مکمل',corrective:'اصلاحی',REPEAT:'تکرار',TIME:'ثانیه',MINUTE:'دقیقه',SECONDS:'ثانیه',FAILURE:'ماکسیمم توان',AMRAP:'بیشترین تکرار',DROPSET:'دراپ ست',SUPERSET:'سوپرست',GIANT_SET:'جاینت‌ست',REST_PAUSE:'استراحت‌ـ‌توقف',
    weight_loss:'کاهش وزن',weight_gain:'افزایش وزن',fitness:'فیتنس',maintenance:'تثبیت وزن',muscle_gain:'عضله‌سازی',fat_loss:'چربی‌سوزی'
  };
