            ...
            <main class="onboarding-card">
              <section class="onboarding-step" data-step="0">
                ...
                <div class="form-grid compact-grid">
                  ...
                  <label class="field-control"><span>شماره همراه <i>ضروری</i></span><input id="personalMobile" inputmode="tel" maxlength="11" autocomplete="tel" value="${esc(student.mobile||'')}" placeholder="09123456789" dir="ltr"></label>
