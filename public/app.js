const menu = [
  ['داشبورد','/coach/dashboard','▦'], ['صفحه اختصاصی','/coach/manage-landing','◇'],
  ['مدیریت حساب',null,'⚙',[['پکیج‌های من','/products/my'],['مدیریت دستیار ها','/coach/assists'],['لیست اشتراک ها','/licence/my'],['خرید اشتراک','/licence/buy'],['مدیریت حرکات تمرینی','/programs/exercise/manage'],['دعوت از مربی ها','/monetization/invite']]],
  ['لیست کارمندان','/employees-list','♙'],['لیست مربی ها','/coach/list','♟'],['کیف پول','/wallet/user-log','◉'],['پایان دوره ها','/call-history/end-durations','◷'],['تاریخچه کیف پول مربی ها','/wallet/full-log','◉'],['شاگرد های من','/users-list','♚'],
  ['اشتراک ها',null,'◌',[['تاریخچه کلی','/licence/list'],['تراکنش ها','/licence/transactions']]],
  ['مدیریت پیام‌های آماده','/messenger/quick-replies','✉'],['بازخورد های سفارشات','/orders/feedback','★'],['لیست مقایسه','/users-compare-images','▧'],['فیدبک تیکت‌ها','/ticket-feedback','☻'],['مشاوره موفقیت آمیز','/successful-call','✓'],['کد تخفیف','/coupon','%'],['پورتال فروش','/presentor-portal','⌁'],['پورتال منشی','/secretary-portal','⌁'],
  ['لیست سفارشات',null,'▤',[['در انتظار تکمیل برنامه','/orders/waiting'],['در انتظار شروع دوره','/orders/waiting-for-duration'],['سفارشات تکمیل شده','/orders/completed'],['گزارش پیشرفته','/orders/advanced'],['تراکنش های مالی','/payments']]],
  ['سفارشات تکمیل نشده','/init-orders-list','!'],['آخرین پیامک‌های ارسالی','/last-sms','✉'],['نمودار فروش کارشناس','/presentor-chart','◫'],['تماس‌های مشتریان من','/presentor/user-calls','☏'],['پرداختی‌های مشتریان من','/presentor/payments','◉'],['لیست انتظار تمرینی','/exercise/wait-list','◷'],['لیست انتظار غذایی','/diet/wait-list','◷'],['لیست انتظار اصلاحی','/corrective/wait-list','◷'],['لیست انتظار مکمل','/supplement/wait-list','◷'],
  ['بانک برنامه ها',null,'▣',[['برنامه های تمرینی','/templates/exercise/list'],['برنامه های غذایی','/templates/diet/list'],['برنامه های مکمل','/templates/supplement/list'],['برنامه های اصلاحی','/templates/corrective/list'],['برنامه های تمرینی (عمومی)','/templates/exercise/list-general'],['برنامه های غذایی (عمومی)','/templates/diet/list-general'],['برنامه های اصلاحی (عمومی)','/templates/corrective/list-general']]],
  ['برنامه ها',null,'▤',[['لیست حرکات تمرینی','/programs/exercise/movements-list'],['لیست غذا های رژیم','/programs/diet/foods-list'],['لیست برچسب‌های غذا','/programs/diet/tag-list'],['لیست پکیج های غذایی','/programs/diet/package-list'],['لیست مکمل‌ها','/programs/supplement/supplement-list']]],
  ['درآمد زایی',null,'◈',[['تاریخچه درآمد مربی ها','/monetization/log']]],['ویدیو های آموزشی','/video-guides','▶'],
  ['رویداد ها',null,'◉',[['لیست رویدادها','/events/list'],['لیست ثبت نام','/events/orders'],['کد های تخفیف','/events/discount'],['تراکنش ها','/events/payments'],['کیف پول رویداد','/events/wallet/user-log'],['بلیت خوان','/events/scanner']]],
  ['دوره ها',null,'▱',[['لیست دوره ها','/courses/list'],['لیست ثبت نام','/courses/orders'],['کد های تخفیف','/courses/discount'],['تراکنش ها','/courses/payments'],['دسته بندی ها','/courses/tags'],['کیف پول دوره ها','/courses/wallet/user-log']]],
...
function render(label,route){
 crumb.textContent=label; document.querySelectorAll('.menu-link').forEach(x=>x.classList.toggle('active',x.dataset.route===route));
