...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط সম্পاد کامل کشف→تکراری‌زدایی→پیش‌نویس→صف بررسی مربی→تأیید و انتشار؛ KI-017 بسته شد) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Task 27 + PROJECT-CONTEXT).
