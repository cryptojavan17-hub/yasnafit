...
### T-2X | یادآور پایان برنامه (PROGRAM_ENDING_REMINDER) + اعلان «تصمیم ارزیابی» برای شاگرد
- **Priority:** P1 • **Status:** OPEN (2026-09-10 — بخش ارزیابیِ ورودی در Task 17 انجام شد)
- **Reason:** «ارسال ارزیابی → ASSESSMENT_READY به مربی» وصل شد؛ مانده: شِدول «چند روز قبل از پایان برنامه» (نیازمند تصمیم مالک) و اعلان نتیجهٔ ارزیابی (تأیید/اصلاح) برای شاگرد — نقطه‌های سرور ~۲۲۷۰ شناسایی شده‌اند.
