...
- **Priority:** P1 • **Status:** OPEN — ممیزی 2026-09-21 انجام شد؛ اصلاحات اجرایی و بازبینی مدل دوم انجام نشده‌اند.
- **Reason:** بخش فعلی ثبت آیدی/لینک است، نه ارسال ربات؛ ضعف اثبات‌شده در مبدأ/نوع درخواست، اعتبارسنجی، محدودسازی، اتمیک‌بودن و رابط. پیوند هویت امن و تحویل تلگرامی وجود ندارد.
- **Next:** بازبینی مستقل [گزارش و طرح فازبندی](TELEGRAM-AUDIT-2026-09-21.md) با [دستورکار مدل دوم](TELEGRAM-SECOND-REVIEW-HANDOFF.md)، سپس اصلاح گاردها/رابط، پیوند نشست به هویت Telegram، دریافت Update و outbox افزودنی. پیش از ارسال خصوصی: پذیرش واقعی با دو حساب آزمایشی. هیچ آیدی قدیمی خودکار verified نشود؛ رازها در چت/گزارش قرار نگیرند.
