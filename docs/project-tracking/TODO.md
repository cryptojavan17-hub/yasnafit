...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط سامپاد کامل + اصلاح ۲ منابع پیش‌فرض + اصلاح ۳ **Inbox ویرایشی «اخبار و مطالب جدید»** با کارت‌ها، og:image، «چرا مهم است»/نکات کلیدی، پنهان‌سازی کامل مدیریت منابع از مربی؛ KI-017 بسته شد) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Task 27).
