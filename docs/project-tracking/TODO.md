...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط سامپاد کامل + اصلاح ۲ منابع پیش‌فرض + اصلاح ۳ Inbox ویرایشی + اصلاح ۴ تصویر/سلسله‌مرابع + اصلاح ۵ نوار پیشرفت زنده + رفع mixed-content/referrer تصویر؛ KI-017 بسته شد) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Task 27).
