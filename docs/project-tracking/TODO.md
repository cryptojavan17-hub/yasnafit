...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط کامل + اصلاح ۲ منابع پیش‌فرض + اصلاح ۳ Inbox + اصلاح ۴ تصویر/سلسله‌مراتب + اصلاح ۵ نوار پیشرفت + اصلاح ۶ بدون-رفرش/سقف ۲۰/جستجو بیشتر/اولویت عکس‌دار + اصلاح ۷ (تصویر کارتـها از API لیست) + اصلاح ۸ (CSP https: برای تصویر og)؛ KI-017 بسته شد) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Task 27).
