...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط সম্পاد کامل + **اصلاح ۲**: منابع پیش‌فرض روز دنیا (PubMed + Google News) با جستجوی خودکار بدون تنظیم، ترجمهٔ AI فارسی با تمرکز بر زنان؛ KI-017 بسته شد) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Task 27).
