...
- **Priority:** P2 • **Status:** **DONE** (Task 27 — 2026-09-20: خط کامل + اصلاح ۲–۸؛ KI-017 بسته شد) • **Correction 9 (rev9 صاحب — 2026-09-20): بازسازی لولۀ کشف/ویرایش مطابق ۱۳ ایراد** — دروازهٔ تازگی (≤۳۰روز/≤۹۰روز علمی؛ قدیمی فقط با نشان always-green از AI)، آماده‌سازی ویرایشی AI **الزامی** (بدون AI = بدون پیش‌نویس)، تیرهای کیفیت منبع (Tier 1 علمی >> عمومی + فیلتر کلیک‌بیت)، گوگل‌نیوز هرگز منبع نهایی (انتشارکنندۀ اصلی)، تصویر اصلی همان مقاله/og/«تصویر موجود نیست»+«انتخاب تصویر» (بدون تصویر رندوم/AI)، شمارش‌های روشن، حذف‌تکراری ۴لایه، کارت مرور بدون دادهٔ فنی، AI هرگز خودکار منتشر نمی‌کند، رفع باگ واقعی اسلاگ فارسی مسیر عمومی مقاله (200→404 اشتباه) • **Dep:** — • **Next:** — (جزئیات: CHANGELOG Correction 9).
