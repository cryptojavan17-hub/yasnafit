...
- **Priority:** P1 • **Status:** OPEN (نیمهٔ اول انجام شد — 2026-09-21: طبق درخواست مالک، مسیر عمومی «ثبت آیدی» حذف و به لینک سادهٔ `https://t.me/yasnafitbot?start=landing` تبدیل شد؛ TG-02/03/04/05/07/08/09/10 در سطح عمومی بسته شدند. چرخهٔ واقعی ربات هنوز وجود ندارد و بازبینی مدل دوم انجام نشده است.)
- **Reason:** بخش فعلی یک لینک است، نه ارسال ربات؛ پیوند هویت تأییدشده و تحویل تلگرامی وجود ندارد.
- **Next:** بازبینی مستقل [گزارش و طرح فازبندی](TELEGRAM-AUDIT-2026-09-21.md) با [دستورکار مدل دوم](TELEGRAM-SECOND-REVIEW-HANDOFF.md)، سپس پیوند نشست به هویت Telegram (nonce یک‌بارمصرف)، دریافت Update و outbox افزودنی. پیش از ارسال خصوصی: پذیرش واقعی با دو حساب آزمایشی. هیچ آیدی قدیمی خودکار verified نشود؛ رازها در چت/گزارش قرار نگیرند.
