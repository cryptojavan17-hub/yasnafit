...
- **Priority:** P1 • **Status:** OPEN • **Reason:** دستور مالک (2026-09-20، Task 21): لندینگ = تصویر کامل طرح؛ «بعدا جای دکمه ها رو مشخص میکنیم». • **Dep:** مشخص‌شدن جای دکمه‌ها توسط مالک. • **Next:** overlay دکمه‌های واقعی/لینک‌ها روی تصویر (ورود مربی، درباره، شروع، مجله) + دسترسی‌پذیری `/coach/login` + تست رگرسن.
