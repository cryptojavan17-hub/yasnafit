...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (مرحلهٔ ۱ از ۴ + اصلاح سایز/تعادل): هیرو لندینگ مطابق Hero.png — عکس قاب‌بندی‌شده با سقف سایز (بدون زوم/برش) + متن متعادل با فضای رزرو برای دکمه‌های آینده (فقط landing.css) (۵۸ گروه + smoke) — قبل‌تر Task 24**
