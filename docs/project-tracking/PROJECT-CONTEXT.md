...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 27 (T-17 + اصلاح ۶): روال «بررسی مطالب جدید» = هر run حداکثر ۲۰ مورد جدید (اولویت: خبرهای عکس‌دار) + دکمهٔ «جستجو بیشتر» برای batch بعدی + نوار پیشرفت **درجا** (بدون رفرش/پرش صفحه)؛ ۶۸ چک + npm test + e2e (schema ۳۶) — قبل‌تر: اصلاح ۵ (پیشرفت/تصویر) + اصلاح ۴ (سلسله‌مراتب منابع) + اصلاح ۳ (Inbox) + اصلاح ۲ + Task ۲۵ مرحلهٔ ۳ + Task ۲۶**
