...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (مرحلهٔ ۱ از ۴ + اصلاح ۴): هیرو = کل Hero.png مالک با سقف عرض 941px وسط‌چین (دسکتاپ جمع‌وجور / موبایل تمام‌عرض؛ تصویر بدون برش) (۵۸ گروه + smoke) — قبل‌تر Task 24**
