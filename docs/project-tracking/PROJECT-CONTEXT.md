...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 27 (T-17 + اصلاح ۷): رفع نبود تصویر در کارت‌های «اخبار و مطالب جدید» (API لیست اکنون `cover_image`/`source_name`/`source_url` را برمی‌گرداند) + اصلاح ۶ (سقف ۲۰/جستجو بیشتر/بدون رفرش) + اصلاح ۵ + اصلاح ۴ + اصلاح ۳ + اصلاح ۲؛ ۶۹ چک + npm test + e2e سبز**
