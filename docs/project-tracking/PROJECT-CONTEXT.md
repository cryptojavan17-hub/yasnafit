...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 26: دکمهٔ «ربات تلگرام» با آیکون تلگرام در هدر (کنار ثبت نام/ورود) → بخش ربات تلگرام شاگرد (پروفایل: @username + اتصال) (۶۱ گروه + e2e + smoke) — قبل‌تر: Task 25 (لندینگ ۲/۴)**
