...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 27 (T-17 + اصلاح ۸): رفع «تصویر بارگذاری نشد» — CSP سراسری `img-src` حالا `https:` را اجازه می‌دهد (تصاویر og بیرونی) + همهٔ کاورها (og/فید) https ذخیره می‌شوند؛ اصلاح ۷ (API لیست) + اصلاح ۶ + اصلاح ۵ + اصلاح ۴ + اصلاح ۳ + اصلاح ۲؛ ۷۱ چک + npm test + e2e سبز**
