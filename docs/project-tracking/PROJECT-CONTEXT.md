...
**آخرین به‌روزرسانی:** 2026-09-19 — **Task 19: بازسازی کامل صفحهٔ اصلی دقیقاً طبق `newlanding.png` (متن‌های verbatim، ۴ کارت نمونه مجله، بج/آمار/CTA/فوتر، socials سه‌گانه)** — بر پایهٔ **Task 18: تطبیق دقیق صفحهٔ اصلی با wireframe `newlanding.png`** (چیدمان تصویر چپ/متن راست، نوار آمار، CTA دو‌ستونه + تنظیم `site.cta_image`، فوتر یک‌ردیفه) + افزونهٔ Task 18: «/» همیشه لندینگ— بر پایهٔ **Task 17: سایت عمومی YASNAFIT (لندینگ + مجله + مقالات) + پنل ویرایشی محتوای مربی `/coach/magazine`** — §۳ (طول server.js، ۳۱ مایگریشن، ۵۳ جدول، ۱۹ سوئیت، سرویس‌های جدید، روت‌ها)، §۴ (فایل‌های جدید)، §۶ (ردیف «Public Website» + «Editorial Admin»), §۱۲ (سوئیت `test:public-site`)، §۱۳ (حالت فعلی). مرجع زندهٔ وضعیت جلسه/استقرار: فایل حافظهٔ ریشهٔ مخزن.
