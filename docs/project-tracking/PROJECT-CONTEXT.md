...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (مرحلهٔ ۲ از ۴ — درباره من): بخش about جدید = کل About Me.png با سقف عرض ۹۴۱px (همان هیرو) + حذف کامل صفحهٔ قدیمی /about (→ ۳۰۲ /#about) (۵۹ گروه + smoke) — قبل‌تر: Task 25 مرحلهٔ ۱ + اصلاح ۴**
