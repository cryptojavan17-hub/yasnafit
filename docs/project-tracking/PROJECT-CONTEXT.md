...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (مرحلهٔ ۱ از ۴ + اصلاح ۳ نهایی): هیرو = کل Hero.png مالک بدون هیچ برش/فاصله/حذفی (تمام‌عرض، byte-identical با main؛ برش‌های قبلی رد شد) (۵۸ گروه + smoke) — قبل‌تر Task 24**
