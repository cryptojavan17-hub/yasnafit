...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 22: هدر واقعی روی لندینگ (لیست دقیق مالک: ۵ لینک + ثبت نام + ورود) + تصویر به عرض ۹۴۱px / موبایل-responsive (T-19 DONE؛ ۵۸ گروه + ۱۹/۱۹ + smoke) — قبل‌تر Task 21**
