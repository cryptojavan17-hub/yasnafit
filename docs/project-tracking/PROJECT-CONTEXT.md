...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (اصلاح مرحلهٔ ۲ از ۴ — درباره من): /about = صفحهٔ جداگانهٔ جدید درباره من (کل About Me.png، همان قاعدهٔ ۹۴۱px) + لینک هدر «درباره من» مستقیم به آن می‌رسد (۶۰ گروه + smoke) — قبل‌تر: مرحلهٔ ۱ + اصلاح ۴**
