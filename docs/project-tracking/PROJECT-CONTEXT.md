...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 25 (مرحلهٔ ۱ از ۴ + اصلاح ۲ ریشه‌ای): هیرو — کانتینر سقف 1160px + ستون‌های 54/46 با gap 40px + عکس object-fit:contain (بدون کشیدگی/برش) + PNG lossless (گپ غیرطبیعی و رندر ناپایدار عکس رفع شد) (۵۸ گروه + smoke) — قبل‌تر Task 24**
