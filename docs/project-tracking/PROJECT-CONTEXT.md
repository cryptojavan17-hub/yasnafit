...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 21: لندینگ = تصویر کامل طرح مرجع `landing2.png` (دستور مالک — «همین تصویر مرجع رو کامل استفاده کن»؛ دکمه‌ها بعدا ⇒ T-19؛ ۵۷ گروه + ۱۹/۱۹ + smoke) — قبل‌تر Task 20**
**نسخه برنامه:** 0.9.1 (مقدار فعلی `package.json` — در Task 17–21 تغییر نکرد) • **وضعیت تست‌ها:** ۱۹/۱۹ سوئیت پاس (اجرای واقعی `npm test` در 2026-09-20 Task 21، سندباکس Agent) + e2e روی سرور زندهٔ 3020 = PASS
