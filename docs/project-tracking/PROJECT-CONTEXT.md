...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 26 (اصلاح — نهایی): ربات تلگرام = کلیک روی دکمهٔ هدر → مودال فقط‌آیدی → ثبت + هدایت مستقیم به t.me/ربات (setting: site.telegram_bot_username) (۶۱ گروه + e2e + smoke) — قبل‌تر: Task 25 (لندینگ ۲/۴)**
