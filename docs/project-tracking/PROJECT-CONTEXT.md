...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 20: تصویرهای اصلی برند لندینگ از طراحی مالک `landing2.png` (فقط عکس‌ها: هیرو/درباره/CTA + ۴ کارت مجله؛ ساختار/متن/دکمه/چیدمان دست‌نخورده؛ ۵۷ گروه + ۱۹/۱۹ + smoke زنده) — قبل‌تر Task 19**
**نسخه برنامه:** 0.9.1 (مقدار فعلی `package.json` — در Task 17–20 تغییر نکرد) • **وضعیت تست‌ها:** ۱۹/۱۹ سوئیت پاس (اجرای واقعی `npm test` در 2026-09-20 Task 20، سندباکس Agent) + e2e روی سرور زندهٔ 3020 = PASS
