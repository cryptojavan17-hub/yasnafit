...
**آخرین به‌روزرسانی:** 2026-09-20 — **Task 24: حذف کامل لندینگ قبلی (تصویر کامل طرح + کدهای خاص آن) — «/» = placeholder مینیمال در پوستهٔ هدر+فوتر مشترک؛ بقیهٔ سایت دست‌نخورده (۵۸ گروه + smoke) — قبل‌تر Task 23**
