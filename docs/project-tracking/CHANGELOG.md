...
- **RESULT:** PASS — در جریان راستی‌آزمایی، یک اشکال دیگر هم گرفته شد: پس از خطای اعتبارسنجی، مقدار تایپ‌شده در فیلدها پاک می‌شد؛ اکنون ورودی‌ها در بازنمایش نگه داشته می‌شوند.
